...
public class AddressBook {
    ...
    private static final String COMMAND_EDIT_DESC = "Edits a person inside the address book.";
    private static final String COMMAND_EDIT_PARAMETERS = "NAME "
                                                      + PERSON_DATA_PREFIX_PHONE + "PHONE_NUMBER "
                                                      + PERSON_DATA_PREFIX_EMAIL + "EMAIL";
    private static final String COMMAND_EDIT_EXAMPLE = COMMAND_ADD_WORD + " John Doe p/98765432 e/johnd@gmail.com";
    ...
    */
     ...
     */
    private static Collection<String> convertToLower(Collection<String> input){
